...
public class ComboBoxAutoCompleteTest extends Application {
	...
	private static final String[] LISTA = { "Abacate", "Abacaxi", "Ameixa", "Amora", "Araticum", "Atemoia", "Avocado",
			...
			"Ovos vermelhos","Buchite,Cindy Pineville", "Buchite,Gene Pineville", "Buchite,Jeremy Jay","Buchanan,Troy Rocky Comfort" ,"1","2","3"};
	...
	public void start(Stage stage) throws Exception {
		...
		stage.show();
		stage.setTitle("Filtering The  ComboBox");
		stage.setWidth(300);
		stage.setHeight(300);
